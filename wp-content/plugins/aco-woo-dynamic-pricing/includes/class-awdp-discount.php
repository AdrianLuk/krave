...
class AWDP_Discount
{
    ...
    public function apply_discount_cart_quantity($rule, $item, $price)
    {
        ...
        // Pricing table texts
        $prcn_text = __('% OFF', 'aco-woo-dynamic-pricing');
        $fxd_text = __(' OFF on cart value', 'aco-woo-dynamic-pricing');
        $fxd_text_two = __(' OFF', 'aco-woo-dynamic-pricing');
        $cart_text = __(' will be deducted from cart', 'aco-woo-dynamic-pricing');
        // End text
