 ...
 *
 * @wordpress-plugin
 * Plugin Name:       WooCommerce Delivery Date & Time Pro
...
if ( $free_version_detect ) {
    echo '<p style="color:#DB3035;font-style:italic;font-family:sans-serif;font-size:20px;font-weight:600;">'.__('Please Deactivate and Delete the Free Version First.', 'coderockz-woo-delivery').'</p>';

    //Adding @ before will prevent XDebug output
    @trigger_error(__('Please Deactivate and Delete the Free Version First.', 'coderockz-woo-delivery'), E_USER_ERROR);
	 ...
	 */
	define( 'CODEROCKZ_WOO_DELIVERY_VERSION', '1.2.76' );
