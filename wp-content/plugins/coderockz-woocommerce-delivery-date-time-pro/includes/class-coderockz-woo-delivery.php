...
class Coderockz_Woo_Delivery {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_coderockz_woo_delivery_add_pickup_location_form', $plugin_admin, 'coderockz_woo_delivery_add_pickup_location_form' );
		...
		$this->loader->add_action( 'wp_ajax_coderockz_woo_delivery_process_category_exclusion_settings', $plugin_admin, 'coderockz_woo_delivery_process_category_exclusion_settings' );
		$this->loader->add_action( 'wp_ajax_coderockz_woo_delivery_process_product_exclusion_settings', $plugin_admin, 'coderockz_woo_delivery_process_product_exclusion_settings' );
        ...
        $this->loader->add_filter( 'woocommerce_order_get_items', $plugin_admin, 'custom_order_get_items', 10, 3 );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_public, 'delete_woo_delivery_plugin_session_cookie' );
		...
		$this->loader->add_action( 'woocommerce_checkout_update_order_review', $plugin_public, 'refresh_shipping_methods', 10, 1 );
		...
		if($add_delivery_info_order_note) {
			$this->loader->add_action( 'woocommerce_new_order', $plugin_public, 'add_delivery_info_order_note',  1, 1  );
		}
		...
		$this->loader->add_action( 'wp_ajax_coderockz_woo_delivery_change_delivery_option_dynamically', $plugin_public, 'coderockz_woo_delivery_change_delivery_option_dynamically' );
		$this->loader->add_action( 'wp_ajax_nopriv_coderockz_woo_delivery_change_delivery_option_dynamically', $plugin_public, 'coderockz_woo_delivery_change_delivery_option_dynamically' );
