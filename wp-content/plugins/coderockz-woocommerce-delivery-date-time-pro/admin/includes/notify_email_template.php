...
<html>
    <head>
        ...
        <title>woo-delivery-development</title>
        <link href="https://fonts.googleapis.com/css?family=Red+Hat+Display:500&display=swap" rel="stylesheet">
    </head>
    <body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="padding: 0;">
        <div id="wrapper" dir="ltr" style="font-family: 'Red Hat Display', sans-serif;font-weight:500;background-color: #f7f7f7; margin: 0; padding: 70px 0; width: 100%; -webkit-text-size-adjust: none;">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="template_header" style='color: #ffffff; border-bottom: 0; font-weight: bold; line-height: 100%; vertical-align: middle; border-radius: 3px 3px 0 0;'>
                                        <tr>
                                            <td id="header_wrapper" style="padding: 36px 48px; display: block;">
                                                <h1 style='font-size: 30px; font-weight: 300; line-height: 150%; margin: 0; text-align: left; text-shadow: 0 1px 0 #ab79a1; color: #96588a;'><?= $email_heading ?></h1>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- End Header -->
...
<div style="margin-bottom: 40px;">
    <table class="td" cellspacing="0" cellpadding="6" border="1" style="color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; width: 100%;">
        ...
        <td class="td" style="color: #636363; border: 1px solid #e5e5e5; padding: 12px; text-align: left; vertical-align: middle;">
            <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol"><?= $currency_symbol; ?><?= $item->get_total(); ?></td>
    </tr>
    <?php } ?>
        ...
        <tfoot>
                    ...
                    <tr>
                        ...
                        <td class="td" style="color: #636363; border: 1px solid #e5e5e5; vertical-align: middle; padding: 12px; text-align: left;"><?= $shipping_method ?></td>
                    </tr>
...
<table id="addresses" cellspacing="0" cellpadding="0" border="0" style="width: 100%; vertical-align: top; margin-bottom: 40px; padding: 0;">
    <tr>
        <td valign="top" width="50%" style="text-align: left; border: 0; padding: 0;">
            <h2 style='color: #96588a; display: block; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;'><?= $notify_email_billing_address_heading; ?></h2>
            ...
            <address class="address" style="padding: 12px; color: #636363;">
                ...
                <h2 style='color: #96588a; display: block; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;'><?= $notify_email_shipping_address_heading; ?></h2>
