...
<div class="coderockz-woo-delivery-container">		
	...
	<div class="coderockz-woo-delivery-vertical-tabs">
		<div class="coderockz-woo-delivery-tabs">
			...
			<button data-tab="tab9"><i class="dashicons dashicons-pressthis" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Custom Time Slot', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab10"><i class="dashicons dashicons-cart" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Pickup Time', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab11"><i class="dashicons dashicons-pressthis" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Custom Pickup Slot', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab12"><i class="dashicons dashicons-location" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Pickup Location', 'coderockz-woo-delivery'); ?></button>
			...
			<button data-tab="tab16"><i class="dashicons dashicons-email-alt" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Notify Email', 'coderockz-woo-delivery'); ?></button>
			...
			<button data-tab="tab20"><i class="dashicons dashicons-admin-settings" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Others', 'coderockz-woo-delivery'); ?></button>
			<?php } ?>
		</div>
		<div class="coderockz-woo-delivery-maincontent">
				...
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
			            ...
			            <form method="post" action="options.php">
			                ...
			                <p style="font-weight:700;font-size:14px;"><?php echo sprintf( esc_html( __( 'Any questions or problems with your license? %sContact us%s!', 'coderockz-woo-delivery' ) ), '<a href="https://coderockz.com/contact">', '</a>' ); ?></p>
			            </form>
			        </div>
			    </div>
			</div>
                ...
                <div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_delivery_restriction_form_submit">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	<span class="coderockz-woo-delivery-form-label" style = "width: 365px!important;"><?php _e('Amount Calculating Including Tax', 'coderockz-woo-delivery'); ?></span>
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_free_shipping_restriction_form_submit">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	...
	                        	<p class="coderockz-woo-delivery-tooltip" tooltip="Enable it if you want to hide other shipping methods if free shipping available. Default is showing all shipping methods."><span class="dashicons dashicons-editor-help"></span></p>
			...
			<div data-tab="tab5" class="coderockz-woo-delivery-tabcontent">
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_date_form_submit">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	...
	                        	<input onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" id="coderockz_delivery_date_maximum_order_per_day" name="coderockz_delivery_date_maximum_order_per_day" type="number" class="coderockz-woo-delivery-number-field" value="<?php echo esc_attr($date_settings['maximum_order_per_day']); ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group" id="coderockz_delivery_date_calendar_locale">
	                    		...
	                    		<select class="coderockz-woo-delivery-select-field" name="coderockz_delivery_date_calendar_locale">
									...
									<option value="uz-latn" <?php if(isset($date_settings['calendar_locale']) && $date_settings['calendar_locale'] == "uz-latn"){ echo "selected"; } ?>>Uzbek Latin</option>
                ...
                <div class="coderockz-woo-delivery-card">
					<p class="coderockz-woo-delivery-card-header"><?php _e('Special Open Days', 'coderockz-woo-delivery'); ?></p>
					<div class="coderockz-woo-delivery-card-body">
						...
						<input class="coderockz-woo-delivery-add-year-btn-delivery-opendays" type="button" value="Add New Year">
									...
									if(isset($opendays_years['open_days']) && !empty($opendays_years['open_days'])) {
										foreach($opendays_years['open_days'] as $year=>$months) {
											...
											foreach($months as $month=>$date) {
												...
												$opendays_html .= '<input id="coderockz_woo_delivery_delivery_opendays_dates" type="text" class="coderockz-woo-delivery-input-field" value="'.$date.'" placeholder="Comma(,) Separeted Date" style="width:200px;vertical-align:top;" autocomplete="off" name="coderockz_woo_delivery_delivery_opendays_dates_'.$month.'_'.$year.'">';
											...
											$opendays_html .= '<br>
												    	  <span style="position:relative;left:18%">
														    <input class="coderockz-woo-delivery-add-month-btn-delivery-opendays" type="button" value="Add Month">
							    ...
							    <div class="coderockz-woo-delivery-add-year-html-delivery-opendays coderockz-woo-delivery-form-group">
							        ...
							        <div class="coderockz_woo_delivery_delivery_opendays_another_month" style="display:inline-block;">
								        <div class="coderockz_woo_delivery_delivery_opendays_add_another_month">
									        ...
									        <input style="width:200px" id="coderockz_woo_delivery_delivery_opendays_dates" type="text" class="coderockz-woo-delivery-input-field" value="<?php  ?>" placeholder="Comma(,) Separeted Date" style="vertical-align:top;" autocomplete="off" disabled="disabled"/>
								    	</div>
							    	</div>
							    	<br/>
							    	<span style="position:relative;left:18%">
									  <input class="coderockz-woo-delivery-add-month-btn-delivery-opendays" type="button" value="Add Month" disabled="disabled">
									  <div class="coderockz-woo-delivery-dummy-btn-delivery-opendays" style="position:absolute; left:0; right:0; top:0; bottom:0; cursor: pointer;"></div>
									</span>
			...
			<div data-tab="tab6" class="coderockz-woo-delivery-tabcontent">
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_pickup_date_form_submit">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_pickup_date_selectable_date"><?php _e('Allow Pickup in the Next', 'coderockz-woo-delivery'); ?></label>
	                    		<p class="coderockz-woo-delivery-tooltip" tooltip="User can only select the number of date from calander that is specified Here. Other dates are disabled. Only numerical value is excepted. Default is 365 days."><span class="dashicons dashicons-editor-help"></span></p>
	                        	<input onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" id="coderockz_pickup_date_selectable_date" name="coderockz_pickup_date_selectable_date" type="number" class="coderockz-woo-delivery-number-field" value="<?php echo esc_attr($pickup_date_settings['selectable_date']); ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	...
	                        	<input onkeyup="if(!Number.isInteger(Number(this.value)) || this.value < 1) this.value = null;" id="coderockz_delivery_date_maximum_pickup_per_day" name="coderockz_delivery_date_maximum_pickup_per_day" type="number" class="coderockz-woo-delivery-number-field" value="<?php echo esc_attr($pickup_date_settings['maximum_pickup_per_day']); ?>" placeholder="" autocomplete="off"/>
	                    	</div>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group" id="coderockz_pickup_date_calendar_locale">
	                    		...
	                    		<select class="coderockz-woo-delivery-select-field" name="coderockz_pickup_date_calendar_locale">
									...
									<option value="uz-latn" <?php if(isset($pickup_date_settings['calendar_locale']) && $pickup_date_settings['calendar_locale'] == "uz-latn"){ echo "selected"; } ?>>Uzbek Latin</option>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		...
	                    		<select class="coderockz-woo-delivery-select-field" name="coderockz_pickup_date_week_starts_from">
	                    			<option value="" <?php if(isset($pickup_date_settings['week_starts_from']) && $pickup_date_settings['week_starts_from'] == ""){ echo "selected"; } ?>>Select Day</option>
                ...
                <div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						...
						<p class="coderockz-woo-delivery-timezone-tab-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' If you want to enable a date that will  disable in future as a reason of weekends, zone wise offdays, state wise offdays or zip wise offdays, then specifiy the date here.', 'coderockz-woo-delivery'); ?></p>
						<input class="coderockz-woo-delivery-add-year-btn-pickup-opendays" type="button" value="Add New Year">
									...
									if(isset($opendays_years['open_days']) && !empty($opendays_years['open_days'])) {
										foreach($opendays_years['open_days'] as $year=>$months) {
											...
											foreach($months as $month=>$date) {
												...
												$opendays_html .= '</select>';
												$opendays_html .= '<input id="coderockz_woo_delivery_pickup_opendays_dates" type="text" class="coderockz-woo-delivery-input-field" value="'.$date.'" placeholder="Comma(,) Separeted Date" style="width:200px;vertical-align:top;" autocomplete="off" name="coderockz_woo_delivery_pickup_opendays_dates_'.$month.'_'.$year.'">';
												if(array_keys($months)[0] != $month) {
											...
											$opendays_html .= '<br>
												    	  <span style="position:relative;left:18%">
														    <input class="coderockz-woo-delivery-add-month-btn-pickup-opendays" type="button" value="Add Month">
							    ...
							    <div class="coderockz-woo-delivery-add-year-html-pickup-opendays coderockz-woo-delivery-form-group">
							        ...
							        <div class="coderockz_woo_delivery_pickup_opendays_another_month" style="display:inline-block;">
								        <div class="coderockz_woo_delivery_pickup_opendays_add_another_month">
									        ...
									        <input style="width:200px" id="coderockz_woo_delivery_pickup_opendays_dates" type="text" class="coderockz-woo-delivery-input-field" value="<?php  ?>" placeholder="Comma(,) Separeted Date" style="vertical-align:top;" autocomplete="off" disabled="disabled"/>
								    	</div>
							    	</div>
							    	<br/>
							    	<span style="position:relative;left:18%">
									  <input class="coderockz-woo-delivery-add-month-btn-pickup-opendays" type="button" value="Add Month" disabled="disabled">
									  <div class="coderockz-woo-delivery-dummy-btn-pickup-opendays" style="position:absolute; left:0; right:0; top:0; bottom:0; cursor: pointer;"></div>
									</span>
									...
									if(isset($offdays_years['off_days']) && !empty($offdays_years['off_days'])) {
										foreach($offdays_years['off_days'] as $year=>$months) {
											...
											foreach($months as $month=>$date) {
												...
												$offdays_html .= '</select>';
												$offdays_html .= '<input id="coderockz_woo_delivery_offdays_dates" type="text" class="coderockz-woo-delivery-input-field" value="'.$date.'" placeholder="Comma(,) Separeted Date" style="width:200px;vertical-align:top;" autocomplete="off" name="coderockz_woo_delivery_offdays_dates_'.$month.'_'.$year.'">';
												if(array_keys($months)[0] != $month) {
							    ...
							    <div class="coderockz-woo-delivery-add-year-html coderockz-woo-delivery-form-group">
							        ...
							        <div class="coderockz_woo_delivery_offdays_another_month" style="display:inline-block;">
								        <div class="coderockz_woo_delivery_offdays_add_another_month">
									        ...
									        <input style="width:200px" id="coderockz_woo_delivery_offdays_dates" type="text" class="coderockz-woo-delivery-input-field" value="<?php  ?>" placeholder="Comma(,) Separeted Date" style="vertical-align:top;" autocomplete="off" disabled="disabled"/>
								    	</div>
							    	</div>
							    	<br/>
							    	<span style="position:relative;left:18%">
	                    ...
	                    <form action="" method="post" id ="coderockz_category_wise_offdays_form_submit">
							...
							if(isset($offdays_settings['category_wise_offdays']) && !empty($offdays_settings['category_wise_offdays'])) {
								foreach($offdays_settings['category_wise_offdays'] as $category => $days) {
									...
									foreach ($all_categories as $cat) {
										$selected = ($cat->name == $category) ? "selected" : "";
										$category_wise_offdays_html .= '<option value="'.str_replace(" ","--",$cat->name).'"'.$selected.'>'.$cat->name.'</option>';
									}
									$category_wise_offdays_html .= '</select>';
									$category_wise_offdays_html .= '<select name="coderockz-delivery-category-wise-offdays-category-weekday-'.str_replace(" ","--",$category).'[]" class="coderockz_delivery_category_wise_offdays_category_weekday" placeholder="Disable Delivery Days" multiple>';

	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                foreach ($weekday as $key => $value) {
	                                	$selected = isset($offdays_settings['category_wise_offdays']) && !empty($offdays_settings['category_wise_offdays']) && in_array($key,$offdays_settings['category_wise_offdays'][$category]) ? "selected" : "";
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
								    ...
								    <select name="coderockz_delivery_category_wise_offdays_category_weekday[]" class="coderockz_delivery_category_wise_offdays_category_weekday" placeholder="Disable Delivery Days" multiple  autocomplete="off">
	                                <?php
	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                foreach ($weekday as $key => $value) {
	                    ...
	                    <form action="" method="post" id ="coderockz_product_wise_offdays_form_submit">
							...
							if(isset($offdays_settings['product_wise_offdays']) && !empty($offdays_settings['product_wise_offdays'])) {
								foreach($offdays_settings['product_wise_offdays'] as $product => $days) {
									...
									$product_wise_offdays_html .= '<select name="coderockz-delivery-product-wise-offdays-product-weekday-'.str_replace(" ","--",$product).'[]" class="coderockz_delivery_product_wise_offdays_product_weekday" placeholder="Disable Delivery Days" multiple>';
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
								    ...
								    <select name="coderockz_delivery_product_wise_offdays_product_weekday[]" class="coderockz_delivery_product_wise_offdays_product_weekday" placeholder="Disable Delivery Days" multiple  autocomplete="off">
	                                <?php
	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                foreach ($weekday as $key => $value) {
	                                    echo '<option value="'.$key.'">'.$value.'</option>';		
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_zone_wise_offdays_form_submit">
							...
							if(isset($offdays_settings['zone_wise_offdays']) && !empty($offdays_settings['zone_wise_offdays'])) {
								foreach($offdays_settings['zone_wise_offdays'] as $zone => $days) {
									...
									$zone_wise_offdays_html .= '<select class="coderockz-woo-delivery-select-field" name="coderockz_delivery_zone_wise_offdays_zone[]">
									...
									$zone_wise_offdays_html .= '<select name="coderockz-delivery-zone-wise-offdays-zone-weekday-'.str_replace(" ","--",$zone).'[]" class="coderockz_delivery_zone_wise_offdays_zone_weekday" placeholder="Disable Delivery Days" multiple>';

	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                if(isset($offdays_settings['zone_wise_offdays'][$zone]['off_days']) && $offdays_settings['zone_wise_offdays'][$zone]['off_days'] !="") {
	                                	$zone_offdays = explode(",",$offdays_settings['zone_wise_offdays'][$zone]['off_days']);
	                                } else {
	                                	$zone_offdays = array();
	                                }
	                                ...
	                                $zone_wise_offdays_html .= '</select>';
									if(array_keys($offdays_settings['zone_wise_offdays'])[0] != $zone){
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
		                        	<img class="coderockz-arrow" src="<?php echo CODEROCKZ_WOO_DELIVERY_URL ?>/admin/images/arrow.png" alt="" style="width: 20px;vertical-align: top;margin-top: 12px;margin-right: 15px;">
								    <select class="coderockz-woo-delivery-select-field" name="coderockz_delivery_zone_wise_offdays_zone[]" autocomplete="off">
								    <option value="">Select Shipping Zone</option>
									<?php
	                                foreach ($zone_name as $key => $value) {
								    ...
								    <select id="coderockz_delivery_zone_wise_offdays_zone_weekday" name="coderockz_delivery_zone_wise_offdays_zone_weekday[]" class="coderockz_delivery_zone_wise_offdays_zone_weekday" placeholder="Disable Delivery Days" multiple  autocomplete="off">
	                                <?php
	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                foreach ($weekday as $key => $value) {
	                                    echo '<option value="'.$key.'">'.$value.'</option>';		
	                    ...
	                    <form action="" method="post" id ="coderockz_state_wise_offdays_form_submit">
							...
							if(isset($offdays_settings['state_wise_offdays']) && !empty($offdays_settings['state_wise_offdays'])) {
								foreach($offdays_settings['state_wise_offdays'] as $state => $days) {
									...
									$state_wise_offdays_html .= '<select name="coderockz-delivery-state-wise-offdays-state-weekday-'.str_replace(" ","--",$state).'[]" class="coderockz_delivery_state_wise_offdays_state_weekday" placeholder="Disable Delivery Days" multiple autocomplete="off">';
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
								    ...
								    <select name="coderockz_delivery_state_wise_offdays_state_weekday[]" class="coderockz_delivery_state_wise_offdays_state_weekday" placeholder="Disable Delivery Days" multiple  autocomplete="off">
	                                <?php
	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                foreach ($weekday as $key => $value) {
	                                    echo '<option value="'.$key.'">'.$value.'</option>';		
	                    ...
	                    <form action="" method="post" id ="coderockz_postcode_wise_offdays_form_submit">
							...
							if(isset($offdays_settings['postcode_wise_offdays']) && !empty($offdays_settings['postcode_wise_offdays'])) {
								foreach($offdays_settings['postcode_wise_offdays'] as $postcode => $days) {
									...
									$postcode_wise_offdays_html .= '<select name="coderockz-delivery-postcode-wise-offdays-postcode-weekday-'.str_replace(" ","--",$postcode).'[]" class="coderockz_delivery_postcode_wise_offdays_postcode_weekday" placeholder="Disable Delivery Days" multiple autocomplete="off">';
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
								    ...
								    <select name="coderockz_delivery_postcode_wise_offdays_postcode_weekday[]" class="coderockz_delivery_postcode_wise_offdays_postcode_weekday" placeholder="Disable Delivery Days" multiple autocomplete="off">
	                                <?php
	                                $weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                                foreach ($weekday as $key => $value) {
	                                    echo '<option value="'.$key.'">'.$value.'</option>';		
			...
			<div data-tab="tab8" class="coderockz-woo-delivery-tabcontent">
				<div class="coderockz-woo-delivery-card">
					<p class="coderockz-woo-delivery-card-header"><?php _e('Store Cutoff/Closing Time Settings', 'coderockz-woo-delivery'); ?></p>
					<div class="coderockz-woo-delivery-card-body">
						...
						<form action="" method="post" id ="coderockz_woo_delivery_store_closing_settings_submit">
							<?php wp_nonce_field('coderockz_woo_delivery_nonce'); ?>
		                    <div class="coderockz-woo-delivery-form-group">
	                        	<span class="coderockz-woo-delivery-form-label" style="width:365px!important"><?php _e('Enable Store Cutoff/Closing Time Functionality', 'coderockz-woo-delivery'); ?></span>
	                    	...
	                    	<?php 
                    			...
                    			if(isset($time_settings['store_closing_time']) && $time_settings['store_closing_time'] !='') {
                    				...
                    				} elseif($store_closing_time == 1440) {
                    		...
                    		?>
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_closing_time"><?php _e('Store Cutoff/Closing Time', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	<span class="coderockz-woo-delivery-form-label" style="width:365px!important"><?php _e('Want Different Closing Time For Different Day', 'coderockz-woo-delivery'); ?></span>
	                    	...
	                    	<div class="coderockz-woo-delivery-different-closing-time-section" style="display:none;">
	                    	<?php
	                    	$weekday = array("0"=>"Sunday", "1"=>"Monday", "2"=>"Tuesday", "3"=>"Wednesday", "4"=>"Thursday", "5"=>"Friday", "6"=>"Saturday");
	                        foreach ($weekday as $key => $value) { 
                    			...
                    			if(isset($time_settings['different_store_closing_time'][$key]) && $time_settings['different_store_closing_time'][$key] != "") {
	                				...
	                				} elseif($store_closing_time_[$key] == 1440) {
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_extend_closing_time" style="width:300px;"><?php _e('Additional Days to close After Store Closing', 'coderockz-woo-delivery'); ?></label>
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_time_form_submit">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
							    ...
							    <label class="coderockz-woo-delivery-toogle-switch" for="coderockz_woo_delivry_as_soon_as_possible_option">
							       <input type="checkbox" name="coderockz_woo_delivry_as_soon_as_possible_option" id="coderockz_woo_delivry_as_soon_as_possible_option" <?php echo (isset(get_option('coderockz_woo_delivery_time_settings')['enable_as_soon_as_possible_option']) && !empty(get_option('coderockz_woo_delivery_time_settings')['enable_as_soon_as_possible_option'])) ? "checked" : "" ?>/>
							       <div class="coderockz-woo-delivery-toogle-slider coderockz-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
	                    	<div class="coderockz-woo-delivery-form-group">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
							    ...
							    <label class="coderockz-woo-delivery-toogle-switch" for="coderockz_hide_searchbox_time_field_dropdown">
							       <input type="checkbox" name="coderockz_hide_searchbox_time_field_dropdown" id="coderockz_hide_searchbox_time_field_dropdown" <?php echo (isset(get_option('coderockz_woo_delivery_time_settings')['hide_searchbox']) && !empty(get_option('coderockz_woo_delivery_time_settings')['hide_searchbox'])) ? "checked" : "" ?>/>
							       <div class="coderockz-woo-delivery-toogle-slider coderockz-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
			...
			<div data-tab="tab9" class="coderockz-woo-delivery-tabcontent">
				...
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
                    	<p class="coderockz-woo-delivery-timezone-tab-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' Please be careful when you splitted a timeslot. Splitted timeslots have to be unique and must not be existed in another timeslot.', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('Ex. Suppose you have 2 main timeslots:', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('1. One main timeslot is 9AM-11AM and splitted by 1 hour so it is making 2 sub timeslots 9AM-10AM and 10AM-11AM', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('2. Another main timeslot is 10AM-12PM and splitted by 1 hour so it is making 2 sub timeslots 10AM-11AM and 11AM-12PM', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('Problem Happening: Look sub timeslot 10AM-11AM exists in both main timeslot. That makes a conflict and maybe 10AM-11AM gives wrong result for Maximum Order For This Slot, Time Slot Fee, Hide For etc because it gets those values from both main timeslot.', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('Hack: If you still need to make timeslot like 9AM-11AM and 10AM-12PM then make timeslot 9AM-11AM and 10:01AM-12:01PM. So when you split the timeslot then the sub timeslot are 9AM-10AM, 10AM-11AM for main timeslot 9AM-11AM and 10:01AM-11:01AM, 11:01AM-12:01PM for main timeslot 10:01AM-12:01PM. Look, all the subtimeslots are unique.', 'coderockz-woo-delivery'); ?></p>
                    	<input class="coderockz-woo-delivery-add-time-slot-btn" type="button" value="Add New Time Slot">
	                    <div id="coderockz-woo-delivery-time-slot-accordion">
                    	  <div class="coderockz-woo-delivery-time-slot-accordion-header" style="display:none;">
                    	  	<p style="font-size:16px;margin:0;font-weight:700"><span class="coderockz-woo-delivery-slot-start-hour">Start Time</span><span class="coderockz-woo-delivery-slot-start-min"></span><span class="coderockz-woo-delivery-slot-start-format"></span> - <span class="coderockz-woo-delivery-slot-end-hour">End Time</span><span class="coderockz-woo-delivery-slot-end-min"></span><span class="coderockz-woo-delivery-slot-end-format"></span></p>
                    	  </div>
						  <div data-plugin-url="<?php echo CODEROCKZ_WOO_DELIVERY_URL; ?>" class="coderockz-woo-delivery-time-slot-accordion-content" style="display:none;">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		...
	                    		<p class="coderockz-woo-delivery-tooltip" tooltip="If you want to hide the timeslot for a specific prduct then select the prduct from here."><span class="dashicons dashicons-editor-help"></span></p>
								  ...
								  <div class="coderockz-woo-delivery-time-slot-accordion-content">
			                    	...
			                    	<div class="coderockz-woo-delivery-form-group">
		                                ...
		                                foreach ($all_categories as $cat) {
		                                	...
		                                	$selected = isset($individual_time_slot['hide_categories']) && !empty($individual_time_slot['hide_categories']) && in_array($cat->name,$individual_time_slot['hide_categories']) ? "selected" : "";
	                    ...
	                    <form action="" method="post" id ="coderockz_pickup_time_form_submit">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		...
	                    		<select class="coderockz-woo-delivery-select-field" name="coderockz_pickup_time_format">
	                    			...
	                    			<option value="" <?php if(isset($pickup_time_settings['time_format']) && $pickup_time_settings['time_format'] == ""){ echo "selected"; } ?>>Select Time Format</option>
			...
			<div data-tab="tab11" class="coderockz-woo-delivery-tabcontent">
				...
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-timezone-tab-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' Please be careful when you splitted a timeslot. Splitted timeslots have to be unique and must not be existed in another timeslot.', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('Ex. Suppose you have 2 main timeslots:', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('1. One main timeslot is 9AM-11AM and splitted by 1 hour so it is making 2 sub timeslots 9AM-10AM and 10AM-11AM', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('2. Another main timeslot is 10AM-12PM and splitted by 1 hour so it is making 2 sub timeslots 10AM-11AM and 11AM-12PM', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('Problem Happening: Look sub timeslot 10AM-11AM exists in both main timeslot. That makes a conflict and maybe 10AM-11AM gives wrong result for Maximum Order For This Slot, Time Slot Fee, Hide For etc because it gets those values from both main timeslot.', 'coderockz-woo-delivery'); ?><br/><br/><?php _e('Hack: If you still need to make timeslot like 9AM-11AM and 10AM-12PM then make timeslot 9AM-11AM and 10:01AM-12:01PM. So when you split the timeslot then the sub timeslot are 9AM-10AM, 10AM-11AM for main timeslot 9AM-11AM and 10:01AM-11:01AM, 11:01AM-12:01PM for main timeslot 10:01AM-12:01PM. Look, all the subtimeslots are unique.', 'coderockz-woo-delivery'); ?></p>
                    	<input class="coderockz-woo-delivery-add-pickup-slot-btn" type="button" value="Add New Pickup Slot">
	                    <div id="coderockz-woo-delivery-pickup-slot-accordion">
                    	  <div class="coderockz-woo-delivery-pickup-slot-accordion-header" style="display:none;">
                    	  	<p style="font-size:16px;margin:0;font-weight:700"><span class="coderockz-woo-delivery-pickup-slot-start-hour">Start Time</span><span class="coderockz-woo-delivery-pickup-slot-start-min"></span><span class="coderockz-woo-delivery-pickup-slot-start-format"></span> - <span class="coderockz-woo-delivery-pickup-slot-end-hour">End Time</span><span class="coderockz-woo-delivery-pickup-slot-end-min"></span><span class="coderockz-woo-delivery-pickup-slot-end-format"></span></p>
                    	  </div>
						  <div data-plugin-url="<?php echo CODEROCKZ_WOO_DELIVERY_URL; ?>" class="coderockz-woo-delivery-pickup-slot-accordion-content" style="display:none;">
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
                                ...
                                if(isset($pickup_location_settings['pickup_location']) && !empty($pickup_location_settings['pickup_location'])) {
									foreach($pickup_location_settings['pickup_location'] as $key => $location) {
								  ...
								  <div class="coderockz-woo-delivery-pickup-slot-accordion-content">
			                    	...
			                    	<div class="coderockz-woo-delivery-form-group">
		                                ...
		                                if(isset($pickup_location_settings['pickup_location']) && !empty($pickup_location_settings['pickup_location'])) {
											foreach($pickup_location_settings['pickup_location'] as $key => $location) {
			                                	...
			                                	$selected = isset($individual_time_slot_pickup['hide_for_pickup_location']) && !empty($individual_time_slot_pickup['hide_for_pickup_location']) && in_array(stripslashes($location),$individual_time_slot_pickup['hide_for_pickup_location']) ? "selected" : "";
			                    	...
			                    	<div class="coderockz-woo-delivery-form-group">
		                                ...
		                                foreach ($all_categories as $cat) {
		                                	...
		                                	$selected = isset($individual_time_slot_pickup['hide_categories']) && !empty($individual_time_slot_pickup['hide_categories']) && in_array($cat->name,$individual_time_slot_pickup['hide_categories']) ? "selected" : "";
		                                    echo '<option value="'.$cat->name.'" '.$selected.'>'.$cat->name.'</option>';
		                                }
		                                ?>
		                                </select>
			...
			<div data-tab="tab12" class="coderockz-woo-delivery-tabcontent">
                ...
                <div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-add-pickup-location-notice"></p>
						<!-- <input class="coderockz-woo-delivery-add-pickup-location-btn" type="button" value="Add New Pickup Location"> -->
	                    <form action="" method="post" id ="coderockz_add_pickup_location_form_submit">
	                        <?php wp_nonce_field('coderockz_woo_delivery_nonce'); ?>
	                        <div class="coderockz-woo-delivery-pickup-location">

	                        <?php
	                        $location_html = "";
							$pickup_location = get_option('coderockz_woo_delivery_pickup_location_settings');
							if(isset($pickup_location['pickup_location']) && !empty($pickup_location['pickup_location'])) {
								foreach($pickup_location['pickup_location'] as $key => $location) {
									$location_html .= '<div class="coderockz-woo-delivery-form-group">';
							        $location_html .= '<p class="coderockz-woo-delivery-pickup-location-serial"><span class="coderockz-woo-delivery-pickup-location-no">'.($key+1).'</span><span>.</span></p>';
									$location_html .= '<input type="text" class="coderockz-woo-delivery-input-field" name="coderockz-woo-delivery-pickup-location-name[]" value="'.stripslashes($location).'" style="vertical-align:top;width: 60%;" autocomplete="off"/>';
									if($key != 0){
										$location_html .= '<button class="coderockz-woo-delivery-pickup-location-remove"><span class="dashicons dashicons-trash"></span></button>';
									}
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
		                        	<p class="coderockz-woo-delivery-pickup-location-serial"><span class="coderockz-woo-delivery-pickup-location-no">1</span><span>.</span></p>
								    <input type="text" class="coderockz-woo-delivery-input-field" name="coderockz-woo-delivery-pickup-location-name[]" value="<?php  ?>" style="vertical-align:top;width: 60%;" autocomplete="off"/>
		                    	</div>
		                    	
		                    <?php } ?>
	                    	</div>
	                    	<button class="coderockz-woo-delivery-add-pickup-location-btn"><span class="dashicons dashicons-plus"></span></button>
	                        <input class="coderockz-woo-delivery-submit-btn" type="submit" name="coderockz_add_pickup_location_form_submit" value="<?php _e('Save Changes', 'coderockz-woo-delivery'); ?>" />
	                    </form>
                	</div>
				...
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_overall_processing_days_settings_form_submit">
	                        <?php wp_nonce_field('coderockz_woo_delivery_nonce'); ?>
	                        <div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_delivery_overall_processing_days" style="width: 180px;text-align: left;"><?php _e('Overall Processing Days', 'coderockz-woo-delivery'); ?></label>
				...
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_processing_time_settings_form_submit">
	                    	...
	                    	?>
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_overall_processing_time_duration" style="width:28%!important;text-align:left!important"><?php _e('Overall Processing Time for All Products', 'coderockz-woo-delivery'); ?></label>
			...
			<div data-tab="tab15" class="coderockz-woo-delivery-tabcontent">
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-time-slot-fee-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' Before This Settings, Please Set Time Slot Starts From & Time Slot Ends At From Delivery Time Tab and <span class="coderockz-woo-delivery-refresh-btn">Refresh The page.</span>', 'coderockz-woo-delivery'); ?></p>
						<p class="coderockz-woo-delivery-time-slot-fee-warning"><span class="dashicons dashicons-megaphone"></span><?php _e('Time slot fee is not working if Custom Time Slot is enabled. Make Custom Time Slot disabled from Custom Time Slot tab and <span class="coderockz-woo-delivery-refresh-btn">Refresh The page</span> for making time slot fee working.', 'coderockz-woo-delivery'); ?></p>
	                    ...
	                    <form action="" method="post" id ="coderockz_woo_delivery_time_slot_fee_form_submit">
										...
										if(isset($delivery_time['delivery_time_ends']) && $delivery_time['delivery_time_ends'] != "") {
											...
											for($i = $delivery_time['delivery_time_starts']; $i<$delivery_time['delivery_time_ends']; $i = $i+(int)$delivery_time['each_time_slot']) {
												...
												if($i+(int)$delivery_time['each_time_slot']>$delivery_time['delivery_time_ends']){
													$option_end = date($time_format, mktime(0, $delivery_time['delivery_time_ends']));
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
									...
									} elseif(!isset($delivery_time['each_time_slot']) || $delivery_time['each_time_slot'] == "") {

										$option_start = date($time_format, mktime(0, $delivery_time['delivery_time_starts']));
										$option_end = date($time_format, mktime(0, $delivery_time['delivery_time_ends']));
                ...
                <div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-time-slot-fee-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' Before This Settings, Please Set Pickup Slot Starts From & Pickup Slot Ends At From Delivery Pickup Tab and <span class="coderockz-woo-delivery-refresh-btn">Refresh The page.</span>', 'coderockz-woo-delivery'); ?></p>
						<p class="coderockz-woo-delivery-time-slot-fee-warning"><span class="dashicons dashicons-megaphone"></span><?php _e('Pickup slot fee is not working if Custom Pickup Slot is enabled. Make Custom Pickup Slot disabled from Custom Pickup Slot tab and <span class="coderockz-woo-delivery-refresh-btn">Refresh The page</span> for making time slot fee working.', 'coderockz-woo-delivery'); ?></p>
	                    ...
	                    <form action="" method="post" id ="coderockz_woo_delivery_pickup_slot_fee_form_submit">
										...
										if(isset($pickup_time_settings['pickup_time_ends']) && $pickup_time_settings['pickup_time_ends'] != "") {
											...
											for($i = $pickup_time_settings['pickup_time_starts']; $i<$pickup_time_settings['pickup_time_ends']; $i = $i+(int)$pickup_time_settings['each_time_slot']) {
												...
												if($i+(int)$pickup_time_settings['each_time_slot']>$pickup_time_settings['pickup_time_ends']){
													$option_end = date($time_format, mktime(0, $pickup_time_settings['pickup_time_ends']));
													$option_value_start = $i;
	                        ...
	                        ?>
		                        <div class="coderockz-woo-delivery-form-group">
									...
									} elseif(!isset($pickup_time_settings['each_time_slot']) || $pickup_time_settings['each_time_slot'] == "") {

										$option_start = date($time_format, mktime(0, $pickup_time_settings['pickup_time_starts']));
										$option_end = date($time_format, mktime(0, $pickup_time_settings['pickup_time_ends']));
				...
				<div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_localization_settings_form_submit">
	                        ...
	                        <div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_order_limit_notice"><?php _e('Timeslot Order Limit exceed Notice', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_pickup_limit_notice"><?php _e('Pickup Limit exceed Notice', 'coderockz-woo-delivery'); ?></label>
	                    		<p class="coderockz-woo-delivery-tooltip" tooltip="Maximum Order Limit Notice. Default is Maximum Order Limit Exceed."><span class="dashicons dashicons-editor-help"></span></p>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_delivery_heading_checkout"><?php _e('Heading of Delivery Section(Checkout Page)', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_delivery_status_not_delivered_text"><?php _e('Delivery Status Not Delivered Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_delivery_status_delivered_text"><?php _e('Delivery Status Delivery Completed Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_pickup_status_not_picked_text"><?php _e('Pickup Status Not Picked Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_pickup_status_picked_text"><?php _e('Pickup Status Pickup Completed Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_delivery_option_notice"><?php _e('Order Type Checkout Page Notice', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_pickup_date_notice"><?php _e('Pickup Date Checkout Page Notice', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_pickup_time_notice"><?php _e('Pickup Time Checkout Page Notice', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_pickup_notice"><?php _e('Pickup Location Checkout Page Notice', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_additional_field_notice"><?php _e('Additional Field Checkout Page Notice', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_delivery_fee_text"><?php _e('Delivery Time Slot Fee Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_checkout_pickup_fee_text"><?php _e('Pickup Slot Fee Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_same_day_delivery_fee_text"><?php _e('Same Day Delivery Fee Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_next_day_delivery_fee_text"><?php _e('Next Day Delivery Fee Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_day_after_tomorrow_delivery_fee_text"><?php _e('Day After Tomorrow Delivery Fee Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_other_day_delivery_fee_text"><?php _e('Other Day Delivery Fee Text', 'coderockz-woo-delivery'); ?></label>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label" for="coderockz_woo_delivery_weekday_fee_text"><?php _e('Week Day Fee Text', 'coderockz-woo-delivery'); ?></label>
			...
			<div data-tab="tab19" class="coderockz-woo-delivery-tabcontent">
				<div class="coderockz-woo-delivery-card">
					<p class="coderockz-woo-delivery-card-header"><?php _e('Category Wise Exclusion', 'coderockz-woo-delivery'); ?></p>
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-category-exclusion-settings-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'coderockz-woo-delivery'); ?></p>
	                    <form action="" method="post" id ="coderockz_delivery_category_exclusion_settings_form_submit">
	                        <?php wp_nonce_field('coderockz_woo_delivery_nonce'); ?>

	                        <div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label"><?php _e('Exclude Product Categories', 'coderockz-woo-delivery'); ?></label>
	                    		<p class="coderockz-woo-delivery-tooltip" tooltip="Select the product categories for which you don't want to give the facility of delivery/pickup."><span class="dashicons dashicons-editor-help"></span></p>
                                ...
                                foreach ($all_categories as $cat) {
                                	...
                                	$selected = isset($exclude_settings['exclude_categories']) && !empty($exclude_settings['exclude_categories']) && in_array($cat->name,$exclude_settings['exclude_categories']) ? "selected" : "";
                                    echo '<option value="'.$cat->name.'" '.$selected.'>'.$cat->name.'</option>';
                                }
                                ?>
                                </select>
	                        ...
	                        <input class="coderockz-woo-delivery-submit-btn" type="submit" name="coderockz_delivery_category_exclusion_settings_form_submit" value="<?php _e('Save Changes', 'coderockz-woo-delivery'); ?>" />
                ...
                <div class="coderockz-woo-delivery-card">
					<p class="coderockz-woo-delivery-card-header"><?php _e('Product Wise Exclusion', 'coderockz-woo-delivery'); ?></p>
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-product-exclusion-settings-notice"><span class="dashicons dashicons-yes"></span><?php _e(' Settings Changed Successfully', 'coderockz-woo-delivery'); ?></p>
	                    <form action="" method="post" id ="coderockz_delivery_product_exclusion_settings_form_submit">
	                        <?php wp_nonce_field('coderockz_woo_delivery_nonce'); ?>

	                        <div class="coderockz-woo-delivery-form-group">
	                    		<label class="coderockz-woo-delivery-form-label"><?php _e('Exclude Individual Product', 'coderockz-woo-delivery'); ?></label>
	                    		<p class="coderockz-woo-delivery-tooltip" tooltip="Select the product for which you don't want to give the facility of delivery/pickup."><span class="dashicons dashicons-editor-help"></span></p>
	                        ...
	                        <input class="coderockz-woo-delivery-submit-btn" type="submit" name="coderockz_delivery_product_exclusion_settings_form_submit" value="<?php _e('Save Changes', 'coderockz-woo-delivery'); ?>" />
                ...
                <div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						...
						<p class="coderockz-woo-delivery-timezone-tab-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' Current Condition: If there is exclusion category\'s products or exclusion products in the cart then whatever there are other category\'s products or other products, the Delivery Date and Time section is hidden'); ?></p>
	                    <form action="" method="post" id ="coderockz_woo_delivery_exclusion_settings_form_submit">
	                        <?php wp_nonce_field('coderockz_woo_delivery_nonce'); ?>
	                        <div class="coderockz-woo-delivery-form-group">
	                        	<span class="coderockz-woo-delivery-form-label" style="width:398px!important"><?php _e('Reverse The Current Condition'); ?></span>
							    ...
							    <label class="coderockz-woo-delivery-toogle-switch" for="coderockz_delivery_exclusion_reverse_current_condition">
							       <input type="checkbox" name="coderockz_delivery_exclusion_reverse_current_condition" id="coderockz_delivery_exclusion_reverse_current_condition" <?php echo (isset($exclude_settings['reverse_current_condition']) && !empty($exclude_settings['reverse_current_condition'])) ? "checked" : "" ?>/>
							       <div class="coderockz-woo-delivery-toogle-slider coderockz-woo-delivery-toogle-round"></div>
							    </label>
	                    	</div>
					...
					<div class="coderockz-woo-delivery-card-body">
	                    ...
	                    <form action="" method="post" id ="coderockz_delivery_other_settings_form_submit">
	                        ...
	                        <div class="coderockz-woo-delivery-form-group">
								...
								<span class="coderockz-woo-delivery-form-label"><?php _e('Spinner Animation in Checkout', 'coderockz-woo-delivery'); ?></span>
								<p class="coderockz-woo-delivery-tooltip" tooltip="Change the spinner animation while loading from here."><span class="dashicons dashicons-editor-help"></span></p>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	<span class="coderockz-woo-delivery-form-label"><?php _e('Hide Heading of Delivery Sectiuon From Checkout Page', 'coderockz-woo-delivery'); ?></span>
	                    	...
	                    	<div class="coderockz-woo-delivery-form-group">
	                        	<span class="coderockz-woo-delivery-form-label"><?php _e('Give access Shop Manager', 'coderockz-woo-delivery'); ?></span>
	                        	<p class="coderockz-woo-delivery-tooltip" tooltip="If you want that the shop manager can do everything with the plugin, enable the option. Default is disable."><span class="dashicons dashicons-editor-help"></span></p>
	                        ...
	                        <div class="coderockz-woo-delivery-form-group">
	                    		...
	                    		<select class="coderockz-woo-delivery-select-field" name="coderockz_woo_delivery_field_position">
	                    			<option value="" <?php if(isset($other_settings['field_position']) && $other_settings['field_position'] == ""){ echo "selected"; } ?>>Select Position</option>
