...
<div class="coderockz-woo-delivery-container">		
	...
	<div class="coderockz-woo-delivery-vertical-tabs">
		<div class="coderockz-woo-delivery-tabs">
			...
			<button data-tab="tab13"><i class="dashicons dashicons-welcome-comments" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Cutoff Time', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab14"><i class="dashicons dashicons-update" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Processing Days', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab15"><i class="dashicons dashicons-backup" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Processing Time', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab16"><i class="dashicons dashicons-images-alt2" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Additional Fees', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab17"><i class="dashicons dashicons-email-alt" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Notify Email', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab18"><i class="dashicons dashicons-admin-page" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Additional Field', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab19"><i class="dashicons dashicons-translation" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Localization', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab20"><i class="dashicons dashicons-dismiss" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Exclusion', 'coderockz-woo-delivery'); ?></button>
			<button data-tab="tab21"><i class="dashicons dashicons-admin-settings" style="margin-bottom: 3px;margin-right: 10px;"></i><?php _e('Others', 'coderockz-woo-delivery'); ?></button>
			<?php } ?>
		</div>
		<div class="coderockz-woo-delivery-maincontent">
			...
			<div data-tab="tab21" class="coderockz-woo-delivery-tabcontent">
                ...
                <div class="coderockz-woo-delivery-card">
					...
					<div class="coderockz-woo-delivery-card-body">
						<p class="coderockz-woo-delivery-time-slot-fee-warning"><span class="dashicons dashicons-megaphone"></span><?php _e(' After importing the file, please <span class="coderockz-woo-delivery-refresh-btn">Refresh The page.</span> to see the settings', 'coderockz-woo-delivery'); ?></p>
						<?php
